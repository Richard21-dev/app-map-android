...
public class FragmentCusco extends Fragment {
    ...
    private ArrayList<GeoPoint> getPointsFromDatabase() {
        ...
        Cursor cursor = dbHelper.getAllPoints(AdminSQLiteData.TABLE_CUSCO); // Obtener puntos de Cusco
    ...
    private String getMarkerTitle(int index) {
        switch (index) {
            case 0:
                return "Plaza de Armas de Cusco";
            case 1:
                return "Sacsayhuamán";
            case 2:
                return "Qorikancha";
