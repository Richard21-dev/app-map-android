...
public class FragmentTrujillo extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_trujillo, container, false);
    ...
    private ArrayList<GeoPoint> getPointsFromDatabase() {
        ...
        Cursor cursor = dbHelper.getAllPoints(AdminSQLiteData.TABLE_TRUJILLO); // Obtener puntos de Trujillo
    ...
    private String getMarkerTitle(int index) {
        switch (index) {
            case 0:
                return "Plaza de Armas de Trujillo";
            case 1:
                return "Chan Chan";
            case 2:
                return "Huacas del Sol y de la Luna";
            case 3:
                return "Museo de Arqueología";
            case 4:
                return "Centro Histórico de Trujillo";
            default:
