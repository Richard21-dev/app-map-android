...
public class FragmentIquitos extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_iquitos, container, false);
    ...
    private ArrayList<GeoPoint> getPointsFromDatabase() {
        ...
        Cursor cursor = dbHelper.getAllPoints(AdminSQLiteData.TABLE_IQUITOS); // Obtener puntos de Iquitos
    ...
    private int getMarkerDrawable(int index) {
        switch (index) {
            case 0:
                return R.drawable.marcador1;
            case 1:
                return R.drawable.marcador2;
            case 2:
                return R.drawable.marcador3;
            case 3:
                return R.drawable.marcador4;
            case 4:
                return R.drawable.marcador5;
            default:
                return R.drawable.marcador1;
        }
    }
    ...
    private String getMarkerTitle(int index) {
        switch (index) {
            case 0:
                return "Plaza de Armas de Iquitos";
            case 1:
                return "Museo de la Amazonía";
            case 2:
                return "Mariposario Pilpintuwasi";
            case 3:
                return "Belen Market";
            case 4:
                return "Reserva Nacional Pacaya Samiria";
            default:
