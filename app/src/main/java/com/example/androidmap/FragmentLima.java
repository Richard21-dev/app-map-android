...
public class FragmentLima extends Fragment {
    ...
    private ArrayList<GeoPoint> getPointsFromDatabase() {
        ...
        Cursor cursor = dbHelper.getAllPoints(AdminSQLiteData.TABLE_LIMA); // Obtener puntos de Lima
    ...
    private String getMarkerTitle(int index) {
        switch (index) {
            case 0:
                return "Plaza Mayor de Lima";
            case 1:
                return "Circuito Mágico del Agua";
            case 2:
                return "Museo Larco";
            case 3:
                return "Huaca Pucllana";
            case 4:
                return "Parque Kennedy";
            default:
